...
//                new Customer("Ivan", "Semenov", 25, "+79604563333", Gender.MALE),
//                //new Customer("Petr", "Kozlov", 32, "+79604563312"),
//                new Customer("Ivan", "Ivanov", 23, "+79604563311", Gender.MALE)};
//
//        products = new Product[]{
//                new Product("Milk", 100.5, Category.NORMAL),
//                new Product("Bread", 70.8, Category.NORMAL),
//                new Product("Meat", 3000, Category.PREMIUM),
//                new Product("Chocolate", 225.6, Category.NORMAL),
//                new Product("Tea", 300, Category.NORMAL)};
//
